...
class Align_near(nn.Module):
    def __init__(self):
        ...
        # deformable
        self.cr1 = nn.Conv2d(128, 64, 3, padding=1, bias=True)
        self.cr2 = nn.Conv2d(64, 64, 3, padding=1, bias=True)
        self.conv1 = nn.Conv2d(128, 64, 3, 1, 1)
        self.conv2 = nn.Conv2d(64, 64, 3, 1, 1)
        self.off2d_1 = nn.Conv2d(64, 18 * 8, 3, padding=1, bias=True)
        self.dconv_1 = DeformConv(64, 64, 3, padding=1, deformable_groups=8)
        self.off2d_2 = nn.Conv2d(64, 18 * 8, 3, padding=1, bias=True)
        self.deconv_2 = DeformConv(64, 64, 3, padding=1, deformable_groups=8)
        self.off2d_3 = nn.Conv2d(64, 18 * 8, 3, padding=1, bias=True)
        self.deconv_3 = DeformConv(64, 64, 3, padding=1, deformable_groups=8)
