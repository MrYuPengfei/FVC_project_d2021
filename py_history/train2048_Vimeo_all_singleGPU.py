...
if __name__ == "__main__":
    ...
    for epoch in range(stepoch, tot_epoch):
        ...
        if epoch % 10 == 0:
            ...
            torch.save(checkpoint, './2048_Vimeo_all_singleGPU/ckpt_best_%s.pth' % (str(epoch)))
        global_step = train(epoch, global_step)
    # torch.save(net, "Deformable_1.model", _use_new_zipfile_serialization=False)
    torch.save(net, "2048_Vimeo_all_singleGPU.model", _use_new_zipfile_serialization=False)
    # !
# end !
