...
from dataset import Vimeo_all       # New_train   # DataSet, TestDataSet, DataSet_Train, Test, DataSet_Train1, DataSet_vimeo,
RESUME = True       # 是否断点续训
torch.backends.cudnn.enabled = True
pth_path = './2048_Vimeo_all_singleGPU/'
start_epoch = 30
...
if __name__ == "__main__":
    ...
    if RESUME:      # added in 20210906,断点续训
        path_checkpoint = pth_path+"ckpt_best_"+str(start_epoch)+".pth"  # 断点路径
    ...
    for epoch in range(stepoch+start_epoch, tot_epoch):
        ...
        if epoch % 10 == 0:
            ...
            torch.save(checkpoint, pth_path+'5e-6_ckpt_best_%s.pth' % (str(epoch)))
        global_step = train(epoch, global_step)
    torch.save(net, pth_path+"model.model" , _use_new_zipfile_serialization=False)
    # !
# end !
